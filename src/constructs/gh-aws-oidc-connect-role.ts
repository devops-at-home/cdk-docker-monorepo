...
import {
  ...
  IGitHubActionsOidcProvider,
} from './gh-aws-oidc-connect-provider';

// FROM: https://github.com/askulkarni2/cdk-gh-aws-oidc-connect/blob/main/src/role.ts
...
export class GitHubActionsRole extends Role {
  constructor(scope: Construct, id: string, props: GitHubActionsRoleProps) {
    ...
    super(scope, id, {
      assumedBy: new WebIdentityPrincipal(providerArn, conditions),
